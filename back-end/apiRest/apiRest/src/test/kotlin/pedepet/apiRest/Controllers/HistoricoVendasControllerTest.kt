...
class HistoricoVendasControllerTest {
    ...
    @Test
    fun `buscarHistoricoVendasPorId() deve estar anotado com @GetMapping('-{id}')`() {

        val metodo = HistoricoVendasController::buscarHistoricoVendasPorId
    ...
    @Test
    fun `Os parâmetros de buscarHistoricoVendasPorId() devem estar anotados com @PathVariable`() {
        val metodo = HistoricoVendasController::buscarHistoricoVendasPorId
